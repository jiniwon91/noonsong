...
class Map_Haebangchon extends StatefulWidget {
  ...
  @override
  _Map_HaebangchonState createState() => _Map_HaebangchonState();
}

class _Map_HaebangchonState extends State<Map_Haebangchon> {
  final LatLng initialPosition =
      const LatLng(37.5422033373691, 126.987251013584);
  final double zoom = 18;
  final String pname = '해방촌·경리단길';
  ...
  void _fetchData() async {
    ...
    _mapData = ApiService.fetchDatafromAPI(pname);
    await _mapData;
    setState(() {
      _isLoading = false;
    });
